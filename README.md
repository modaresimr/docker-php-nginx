...
[![Docker Pulls](https://img.shields.io/docker/pulls/modaresimr/php-nginx.svg)](https://hub.docker.com/r/trafex/php-nginx/)
...
## [![modaresimr Consultancy](https://timdepater.com/logo/mini-logo.png)](https://timdepater.com?mtm_campaign=github)
...
Start the Docker container:
    ...
    docker run -p 80:8080 modaresimr/php-nginx

See the PHP info on http://localhost, or the static html page on http://localhost/test.html

Or mount your own code to be served by PHP-FPM & Nginx

    docker run -p 80:8080 -v ~/my-codebase:/var/www/html modaresimr/php-nginx
